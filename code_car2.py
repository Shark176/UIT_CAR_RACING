...
def DeterminePosition(filted):
    if filted == 0b11100111 or filted == 0b11000011 or filted == 0b10000001:
        return MID
    elif (str_filted[0] == '0' and str_filted[5:8] == '111') or filted == 0b10000111: #or filted == 0b10000111 or str_filted[:4] == '0':
        return LEFT_VUONG
    elif (str_filted[4:8] == '1111' and str_filted[:4] != '1111'):
        return LEFT
    elif ((str_filted[7] == '0') and (str_filted[:3] == '111')) or filted == 0b11100001:# or filted == 0b11100001 or str_filted[3:8] == '0':
        return RIGHT_VUONG
...
while robot.step(timestep) != -1:
    ...
    if pos == MID:
        ...
        VongXuyen()
        print('vong xoay')
    elif pos == RIGHT_VUONG and VongXuyen_Signal:
        for i in range(40):
            robot.step(timestep)
            lm.setVelocity(1 * MAX_SPEED)
        ...
        lm.setVelocity(1 * MAX_SPEED)
        rm.setVelocity(1 * MAX_SPEED) 
    if (lastPos == LEFT_VUONG or preFilted == 0b00000111 or preFilted == 0b10000111) and pos != FULL_SIGNAL and pos != LEFT_VUONG and (pos == MID or filted == 0b11110111 or filted == 0b11101111):
        NgaTuLeft_Signal = True
    elif (lastPos == RIGHT_VUONG or preFilted == 0b11100000 or preFilted == 0b11100001) and pos != FULL_SIGNAL and pos != RIGHT_VUONG and (pos == MID or filted == 0b11101111 or filted == 0b11110111):
